...
do
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        -- ESP tab: requested checkbox controls.
        local esp = tabList:newTab("ESP"):intoSections()
        do
            local espOptions = esp:newSection("left", "ESP")
        ...
        local visual= tabList:newTab("Visual"):intoSections()
        do
            local nametags = visual:newSection("left", "Names")
            ...
            local healthbars = visual:newSection("left", "Health Bars")
            ...
            local chams = visual:newSection("right", "Chams")

    ...
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        do
            ...
            do
                ...
                -- The toggle/dropdown objects in this UI do not expose
                -- a public `.changed` event, so do not index them here.
                -- Keep the panel hidden initially; the existing UI state
                -- machinery remains responsible for the toggle itself.
                updateCosmeticPanel(false)
            end

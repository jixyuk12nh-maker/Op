    ...
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        do
            ...
            do
                ...
                aimbotFov:newToggle("main/aimbot/show_fov"):setLabel("Show Fov")
                aimbotFov:newToggle("main/aimbot/outline"):setLabel("Outline")
                aimbotFov:newToggle("main/aimbot/fill"):setLabel("Fill")
                aimbotFov:newToggle("main/aimbot/radius"):setLabel("Radius")
                aimbotFov:newToggle("main/aimbot/smoothing"):setLabel("Smoothing")
            end
            ...
            do
                ...
                silentFov:newToggle("main/silent_aim/show_fov"):setLabel("Show Fov")
                silentFov:newToggle("main/silent_aim/outline"):setLabel("Outline")
                silentFov:newToggle("main/silent_aim/fill"):setLabel("Fill")
                silentFov:newToggle("main/silent_aim/radius"):setLabel("Radius")
            end

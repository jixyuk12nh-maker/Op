        ...
        do
            ...
            do
                ...
                local function refresh()
                    ...
                    clear(list)
                    local ok, data = pcall(shared.CosmeticChanger.GetCosmetics, selectedWeapon, selectedType)
                    ...
                    for _,name in ipairs(data) do
                        ...
                        b.MouseButton1Click:Connect(function()
                            local okApply,err=pcall(shared.CosmeticChanger.Apply,selectedWeapon,name,selectedType)
                ...
                local function build()
                    ...
                    local ok,data=pcall(shared.CosmeticChanger.GetWeapons)

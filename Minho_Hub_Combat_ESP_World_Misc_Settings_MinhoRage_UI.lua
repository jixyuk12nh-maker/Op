...
do
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        do
            ...
            -- Minho Hub Rage: UI toggle only.
            -- The toggle is intentionally local/UI-only and does not modify other
            -- players, projectiles, or game physics.
            do
                local minhoRage = rage:newSection("left", "Minho Hub Rage")
                minhoRage:newToggle("main/rage/minho_hub_rage"):setLabel("Minho Hub Rage")
            end
        end

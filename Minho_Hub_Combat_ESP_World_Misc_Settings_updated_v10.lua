...
do
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        do
            ...
            do
                local mainSettings = aimbot:newSection("right", "Main")
            ...
            do
                local mainSettings = silentaimtab:newSection("right", "Main")
            ...
            do
                local mainSettings = triggerbot:newSection("right", "Main")
